...
namespace ScreenCaptureUtility
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            // ✅ First launch: check if save folder is set
        ...
        private void InitializeUnifiedUI()
        {
            ...
            // ✅ New button to change save location
            btnChangeLocation = new Button
            {
                Text = "Save Location",
                Location = new Point(chkStayOnTop.Left, chkStayOnTop.Bottom + 10), //below checkbox
                Size = new Size(200, 30),
                Font = new Font("Segoe UI", 9)
            };
            btnChangeLocation.Click += (s, e) => ChooseSaveFolder();
            bottomPanel.Controls.Add(btnChangeLocation);
        ...
        private void ChooseSaveFolder()
        {
            ...
            {
                fbd.Description = "Select a folder to save captures";
                if (fbd.ShowDialog() == DialogResult.OK)
                {
                    Settings.Default.SaveFolder = fbd.SelectedPath;
                    Settings.Default.Save();
                    lblStatus.Text = $"Save location set: {fbd.SelectedPath}";
                }
            }
        }
    }
